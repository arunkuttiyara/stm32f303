...
/*
 ...
 lcd library function use in STM32
...
#include "common.h"
#include "44780hd_lib.c"

/* Private variables ---------------------------------------------------------*/
const Led_TypeDef LEDs[] = {LED3, LED4, LED5, LED6, LED7, LED8, LED9, LED10};
const uint32_t numLEDs = sizeof(LEDs)/sizeof(LEDs[0]);

extern void LCD_Init();	// library function to initialize lcd
extern void LCD_Print();// library function to print a string

GPIO_InitTypeDef        GPIO_InitStruct;                     // GPIO port structure
