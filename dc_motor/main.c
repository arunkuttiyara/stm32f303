...
extern int get_motor_speed(); //to get the dc motor speed
extern int pwm_value; 
extern int uwTick;
extern void adc_init_new(); // initialize tachometer reading
extern void dc_speed(int); // changing the dc motor speed
volatile int state=0;
volatile int sec=0,read_flag;
...
int main(int argc, char **argv)
{
	...
	// initializing TIM15 to generate generate pwm on pb14
	__TIM15_CLK_ENABLE();
	TIM15->PSC = 72; /* Set prescaler */
	TIM15->ARR = 1000; /* */
	//	TIM15->DIER = 0x01;
	TIM15->CR1 = 0x01; /* Enable timer */
	TIM15->CNT = 0; /* Reset counter */
	TIM15->CCR1 = 500; /* Reset counter */
